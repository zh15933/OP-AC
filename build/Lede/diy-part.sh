...
# 删除水哥库的passwall
rm -rf openwrt/feeds/passwall1.*
rm -rf openwrt/feeds/passwall2.*
rm -rf openwrt/feeds/passwall3.*
...
export DNS_Settings="2235.5.5.5"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
